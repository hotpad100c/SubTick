...
public class HudRenderer
{
            ...
            Component[] queue, TickPhase phase, int iqueue1, int iqueue2, int iqueue3, int x, int y, int wDim, int wPhase, int wQueue, int h)
    {
        ...
        drawTableB(builder, x, y, h, wDim, ClientTickHandler.dimensions.size(), phase.dim());
        drawTableB(builder, x+wDim+10, y, h, wPhase, TickPhase.totalPhases, phase.phase());
        drawTableC(builder, x+wDim+wPhase+20, y, h, wQueue, queue.length, iqueue1, iqueue2, iqueue3);
    ...
    {
        buffer.addVertex(x, y, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(x, Y, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(X, Y, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(X, y, 0f).setColor(color.r, color.g, color.b, color.a);
    }
    ...
    {
        buffer.addVertex(x1, y1, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(x2, y2, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(x3, y3, 0f).setColor(color.r, color.g, color.b, color.a);
        buffer.addVertex(x4, y4, 0f).setColor(color.r, color.g, color.b, color.a);
    }
}

...
public class HudRenderer
{
    ...
    private static void drawTableA(GuiGraphics guiGraphics, int x, int y, int h, int w, int count, int index)
    {
        // Left & right borders
        int Y = y + count * h + 1;
        int X = x + w;
    ...
    private static void drawTableB(GuiGraphics guiGraphics, int x, int y, int h, int w, int count, int index)
    {
        // Left & right borders
        int Y = y + count * h + 1;
        int X = x + w;
    ...
    private static void drawTableC(GuiGraphics guiGraphics, int x, int y, int h, int w, int count, int index1, int index2, int index3)
    {
        // Left & right borders
        int Y = y + count * h + 1;
        int X = x + w;
    ...
    private static void drawRect(GuiGraphics guiGraphics, int x, int y, int X, int Y, Color4f color)
    {
